...
<body>
    ...
    <div class="wrapper">
            ...
            <table class="info-table">
                <tr>
                    ...
                    <td>
                        ...
                        <div class="status-tag">LUNAS</div>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table class="bottom-table">
            <tr>
                <td class="notes-area">
                    <div style="font-weight: bold; margin-bottom: 8px; font-size: 9.5pt; color: #1e293b;"></div>
                    <div style="font-size: 8.5pt; color: #64748b; line-height: 1.6;">
                        
                    </div>
                </td>
                <td class="summary-area">
                    <table class="summary-table">
                        <tr>
                            <td style="color: #64748b;">Total Tagihan</td>
                            <td style="text-align: right; font-weight: bold; color: #1e293b;">Rp {{ number_format($loan->fine_amount, 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td style="color: #64748b; padding-bottom: 15px;">Total Bayar</td>
                            <td style="text-align: right; font-weight: bold; color: #1e293b; padding-bottom: 15px;">Rp {{ number_format($loan->amount_paid, 0, ',', '.') }}</td>
                        </tr>

                        @php
                            $totalKembali = $loan->amount_paid - $loan->fine_amount;
                        @endphp

                        <tr class="total-row">
                            <td>KEMBALIAN</td>
                            <td style="text-align: right;">Rp {{ number_format($totalKembali, 0, ',', '.') }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
