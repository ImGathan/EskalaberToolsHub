...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div
        ...
        <form id="add-form" class="p-6" navigate-form action="{{ route('toolsman.tools.create') }}" method="POST">
            @csrf
            ...
            <div class="space-y-4">
                        ...
                        <div class="space-y-2 text-center">
                            <div class="flex justify-center relative">
                                <div class="relative inline-block">
                                    <img src="{{ $response->image ?? asset('admin/images/empty-data.webp') }}" 
                                        id="preview-img" 
                                        class="h-24 w-24 object-cover rounded-lg border shadow-sm">

                                    <button type="button" id="remove-btn" onclick="removeImage(event)" 
                                        class="hidden absolute -top-2 -right-2 bg-red-500 text-white rounded-full p-1 hover:bg-red-600 shadow-md items-center justify-center w-6 h-6 transition-all">
                ...
                <div>
                    <label for="category_id" class="block text-sm font-medium mb-2 dark:text-white">Kategori <span
                            class="text-red-500">*</span></label>
                    <input type="text" id="category_id" name="category_id" value="{{ $categories->first()->name }}"
                ...
                <div>
                    <label for="category_id" class="block text-sm font-medium mb-2 dark:text-white">Lokasi Barang <span
                            class="text-red-500">*</span></label>
                    <select id="place_id" name="place_id"
                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 @error('place_id') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror"
                        required>
                ...
                {{-- Fine --}}
                <div>
                    <label for="fine" class="block text-sm font-medium mb-2 dark:text-white">Harga Denda Keterlambatan <span
                            class="text-red-500">*</span></label>
                    <input type="number" id="fine" name="fine" value="{{ old('fine') }}"
                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 placeholder-neutral-300 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 @error('quantity') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror"
