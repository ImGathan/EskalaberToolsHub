                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-3">
                                        <div class="flex items-center gap-x-3">
                                            <span
                                                class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $tool->name }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="px-6 py-3">
                                        <span
                                            class="text-sm font-medium text-gray-800 dark:text-neutral-200">{{ $tool->quantity }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="px-6 py-3">
                                        <span
                                            class="text-sm font-medium text-gray-800 dark:text-neutral-200">{{ $tool->category->name }}</span>
                                    </div>
                                </td>
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-3">
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                class="text-sm font-medium text-gray-800 dark:text-neutral-200">{{ $tool->toolsman->username }}</span>
                                            <span class="text-xs text-gray-500 dark:text-neutral-500">
                                                {{ $tool->toolsman->class ?? '-' }}</span>
                                        </div>
                                        @else
                                ...
                                <td>
                                    <div class="px-6 py-3">
                                        <span
                                            class="text-sm font-medium text-gray-800 dark:text-neutral-200">{{ $tool->status }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-1.5 flex items-center gap-x-1">
                                        <a navigate
                                            ...
                                            href="{{ route('toolsman.tools.update', $tool->id) }}" title="Edit">
                                        ...
                                        <button type="button"
                                            ...
                                            onclick="setDeleteData('{{ $tool->id }}', '{{ $tool->name }}', '{{ $tool->image }}', '{{ $tool->category->name }}')">
        ...
        <div
            ...
            <div class="absolute top-2 end-2">
                <button type="button"
                    ...
                    @include('_toolsman._layout.icons.close_modal')
                </button>
            </div>
