...
@section('title', 'Tambah Jurusan/Unit Baru')
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-neutral-700 flex items-center">
            ...
            <div class="ms-3">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-neutral-200">
                    Tambah Jurusan/Unit Baru
                </h2>
            </div>
        </div>

        <form id="add-form" class="p-6" navigate-form action="{{ route('admin.departments.create') }}" method="POST">
            @csrf

            <div class="space-y-4">
                {{-- Name --}}
                <div>
                    <label for="name" class="block text-sm font-medium mb-2 dark:text-white">Nama Jurusan/Unit <span
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}"
                        ...
                        placeholder="Contoh: RPL 1" required>
                    @error('name')
            ...
            <div class="mt-4 flex justify-start gap-x-2">
                <a navigate href="{{ route('admin.departments.index') }}"
