...
<div class="grid gap-3 md:flex md:justify-between md:items-center py-4">
    <div>
        ...
        <p class="text-md text-gray-400 dark:text-neutral-400">
            Manajemen daftar jurusan/unit pengguna.
        </p>
    </div>
...
<div class="flex flex-col">
    ...
    <div class="px-2 pb-4">
        <form action="{{ route('admin.departments.index') }}" method="GET" navigate-form
            ...
            <div class="sm:w-64">
                <input type="text" name="keywords" id="keywords" value="{{ $keywords ?? '' }}"
                    ...
                    placeholder="Cari nama jurusan/unit...">
            </div>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-neutral-700">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                            <div class="flex justify-end items-center gap-x-2">
                                <a navigate href="{{ route('admin.departments.update', $department->id) }}" 
                                ...
                                <button type="button" onclick="setDeleteData('{{ $department->id }}', '{{ $department->name }}')"
    ...
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
        <div class="relative flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <div class="p-4 sm:p-10 text-center">
                ...
                <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-neutral-200">Hapus Jurusan/Unit</h3>
                <p class="text-gray-500 dark:text-neutral-500">
                    Apakah Anda yakin ingin menghapus <span id="delete-department-name" class="font-semibold text-gray-800 dark:text-neutral-200"></span>?<br>
...
<script>
    function setDeleteData(id, name) {
        ...
        document.getElementById('delete-form').action = '{{ url("admin/departments/delete") }}/' + id;
    }
</script>
@endsection