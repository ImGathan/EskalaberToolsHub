                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-3">
                                        <div class="flex items-center gap-x-3">
                                            ...
                                            <div class="grow">
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $department->name }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="size-px whitespace-nowrap">
                                    <div class="px-6 py-1.5 flex items-center gap-x-1">
                                        <a navigate
                                            ...
                                            href="{{ route('admin.departments.update', $department->id) }}" title="Edit">
                                        ...
                                        <button type="button"
                                            ...
                                            onclick="setDeleteData('{{ $department->id }}', '{{ $department->name }}')">
