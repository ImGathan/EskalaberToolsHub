                        ...
                        <form action="{{ route('admin.users.index') }}" method="GET" navigate-form
                            ...
                            <div class="sm:w-48">
                                <select name="access_type"
                                    ...
                                    <option value="1" {{ ($access_type ?? '') == '1' ? 'selected' : '' }}>Admin
                                    </option>
                                    <option value="2" {{ ($access_type ?? '') == '2' ? 'selected' : '' }}>Toolsman
                                    </option>
                                    <option value="3" {{ ($access_type ?? '') == '3' ? 'selected' : '' }}>User
                                    </option>
                                </select>
                            </div>
                            <div>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <div class="flex items-center gap-x-3">
                                                    ...
                                                    <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $d->username }}</span>
                                                        <span
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-1.5 flex items-center gap-x-1">
                                                ...
                                                <button type="button"
                                                    ...
                                                    onclick="setDeleteData('{{ $d->id }}', '{{ $d->username }}')">
