...
<div class="flex flex-col">
    ...
    <div class="px-2 pb-4">
        <form action="{{ route('admin.types.index') }}" method="GET" navigate-form
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-neutral-700">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                            <div class="flex justify-end items-center gap-x-2">
                                <a navigate href="{{ route('admin.types.update', $type->id) }}" 
                                ...
                                <button type="button" onclick="setDeleteData('{{ $type->id }}', '{{ $type->name }}')"
    ...
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
        <div class="relative flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <div class="p-4 sm:p-10 text-center">
                ...
                <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-neutral-200">Hapus Jenis Barang</h3>
                <p class="text-gray-500 dark:text-neutral-500">
                    Apakah Anda yakin ingin menghapus <span id="delete-type-name" class="font-semibold text-gray-800 dark:text-neutral-200"></span>?<br>
...
<script>
    function setDeleteData(id, name) {
        ...
        document.getElementById('delete-form').action = '{{ url("admin/types/delete") }}/' + id;
    }
</script>
@endsection