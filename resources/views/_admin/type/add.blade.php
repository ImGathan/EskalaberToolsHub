...
@section('title', 'Tambah Jenis Barang Baru')
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div
        ...
        <form id="add-form" class="p-6" navigate-form action="{{ route('admin.types.create') }}" method="POST">
            @csrf

            <div class="space-y-4">
                {{-- Name --}}
                <div>
                    <label for="name" class="block text-sm font-medium mb-2 dark:text-white">Nama Jenis Barang <span
            ...
            <div class="mt-4 flex justify-start gap-x-2">
                <a navigate href="{{ route('admin.types.index') }}"
