...
<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
    <!-- Card -->
    <div
        class="flex flex-col bg-white border border-gray-100 shadow-md shadow-indigo-500/10 rounded-2xl dark:bg-neutral-800 dark:border-neutral-700">
...
<div class="grid lg:grid-cols-2 gap-4 sm:gap-6">
    <!-- Card -->
    <div
        class="p-4 md:p-5 min-h-102.5 flex flex-col bg-white border border-gray-100 shadow-md shadow-indigo-500/10 rounded-2xl dark:bg-neutral-800 dark:border-neutral-700">
        <!-- Header -->
...
<div class="flex flex-col">
    <div
        ...
        <div class="min-w-full inline-block align-middle">
            <div
                class="bg-white border border-gray-100 rounded-2xl shadow-md shadow-indigo-500/10 overflow-hidden dark:bg-neutral-800 dark:border-neutral-700">
                <!-- Header -->
                <div
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                    <thead class="bg-gray-50/50 dark:bg-neutral-800">
                        <tr>
                            ...
                            <th scope="col" class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3 text-start">
                                <div class="flex items-center gap-x-2">
                                    <span class="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-neutral-400">
                                        Name
                                    </span>
                                </div>
                            </th>
