...
@section('title', 'Tambah Toolsman Baru')
            ...
            <div class="px-6 py-4 border-b border-gray-200 dark:border-neutral-700 flex items-center">
                ...
                <div class="ms-3">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-neutral-200">
                        Tambah Toolsman Baru
                    </h2>
                </div>
            </div>

            <form id="add-form" class="p-6" navigate-form action="{{ route('admin.toolsmans.create') }}" method="POST">
                @csrf

                <div class="space-y-4">
                    {{-- Name --}}
                    <div>
                        <label for="username" class="block text-sm font-medium mb-2 dark:text-white">Nama Lengkap <span
                    ...
                    <!-- <div>
                        ...
                        <input type="text" id="class" name="class" value="{{ old('class') }}"
                            class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 placeholder-neutral-300 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 @error('class') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror"
